...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading = false, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: "bg-indigo-600 text-white hover:bg-indigo-500 active:scale-[0.98] shadow-lg shadow-indigo-500/25 focus:ring-indigo-500",
      ...
      danger: "bg-rose-600 text-white hover:bg-rose-500 active:scale-[0.98] focus:ring-rose-500"
    }
